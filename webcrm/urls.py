...
# Root path redirects to SECRET_CRM_PREFIX (usually /en/)
urlpatterns = [
    path('', lambda request: redirect(settings.SECRET_CRM_PREFIX)),
...
# Include rosetta if installed
if 'rosetta' in settings.INSTALLED_APPS:
    urlpatterns += [
        path('rosetta/', include('rosetta.urls'))
    ]

# i18n patterns for CRM and related apps
